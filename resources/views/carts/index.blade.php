                            ...
                            <div class="sm:col-span-2">
                                <div class="mb-2 flex items-center gap-1">
                                    <label for="delivery-methods-modal"
                                           class="block text-sm font-medium text-gray-900 dark:text-white"> Delivery
                                        Methods </label>
                                    <svg data-tooltip-target="delivery-methods-modal-desc-3"
                                        ...
                                        <div class="flex items-start">
                                            ...
                                            <div class="ms-4 text-sm">
                                                <label for="mastercard"
                                                       class="font-medium text-gray-900 dark:text-white"> Mastercard
                                                    ending in 8429 </label>
                                ...
                                <div class="flex items-center gap-4 sm:col-span-2">
                                    <div class="flex items-center">
                                        ...
                                        <label for="payment_method_new_modal"
                                               class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Add
